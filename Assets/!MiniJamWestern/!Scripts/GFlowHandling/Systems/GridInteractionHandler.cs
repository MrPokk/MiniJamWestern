...
public class GridInteractionHandler
{
    ...
    public static bool TryGetEntityAt(Vector2Int index, out EcsEntity entity)
    {
    ...
    public static bool TryGetEntityAt(Vector3 worldPosition, out EcsEntity entity)
    {
        return TryGetEntityAt(Playfield.ConvertingPosition(worldPosition), out entity);
    }

    public static bool MoveEntity(EcsEntity entity, Vector2Int toIndex)
    {
    ...
    public static bool MoveEntity(EcsEntity entity, Vector3 toWorldPosition)
    {
        return MoveEntity(entity, Playfield.ConvertingPosition(toWorldPosition));
    }
}
